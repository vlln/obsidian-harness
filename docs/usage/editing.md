...
Obsidian Harness allows AI agents to edit files in your vault and working directory.
...
In **Settings → Obsidian Harness → Permissions → Auto-allow permissions**, you can automatically allow all permission requests from agents.
...
Configure these in **Settings → Obsidian Harness → Display**.
